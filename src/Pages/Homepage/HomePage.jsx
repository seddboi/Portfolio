		...
		<ThemeProvider theme={theme}>
							...
							<svg width="120" height="100" viewBox="0 0 120 100" fill="none" xmlns="http://www.w3.org/2000/svg">
								<g id="triangles">
									<g id="dark">
										<path
											id="dark1"
											d="M63.1306 55.7012C62.7491 56.3547 61.8081 56.364 61.4136 55.7182L49.9997 37.0305C49.595 36.3679 50.0669 35.517 50.8432 35.5093L73.2988 35.287C74.0752 35.2793 74.5638 36.1207 74.1723 36.7912L63.1306 55.7012Z"
											opacity="0.5"
										/>
										<path
											id="dark2"
											d="M63.1306 43.7012C62.7491 44.3547 61.8081 44.364 61.4136 43.7182L49.9997 25.0305C49.595 24.3679 50.0669 23.517 50.8432 23.5093L73.2988 23.287C74.0752 23.2793 74.5638 24.1207 74.1723 24.7912L63.1306 43.7012Z"
											opacity="0.5"
										/>
									</g>
								</g>
			...
			<Box sx={{ backgroundColor: 'var(--white)' }}>
				<Box className="peaks" sx={{ zIndex: '-1' }}>
					...
					>
						<path
							d="M0 438L35 309L69 389L104 186L138 256L173 170L208 176L242 226L277 321L312 180L346 255L381 221L415 405L450 302L485 217L519 310L554 332L588 399L623 232L658 366L692 439L727 342L762 318L796 431L831 239L865 386L900 388L900 601L865 601L831 601L796 601L762 601L727 601L692 601L658 601L623 601L588 601L554 601L519 601L485 601L450 601L415 601L381 601L346 601L312 601L277 601L242 601L208 601L173 601L138 601L104 601L69 601L35 601L0 601Z"
							fill="#222831"
